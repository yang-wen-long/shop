		...
		<form action="{{url('/admin/store')}}" method="post">
			...
			<table border="1">
				...
				<tr>
					<td>手机号</td>
					<td>
						<input type="text" name="admin_mobile" placeholder="手机号">
						<b style="color:red;">{{$errors->first("admin_mobile")}}</b>
					</td>
				</tr>
				<tr>
					<td>邮箱</td>
					<td>
						<input type="text" name="admin_mailbox" placeholder="邮箱">
						<b style="color:red;">{{$errors->first("admin_mailbox")}}</b>
					</td>
				</tr>
				<tr>
					<td>密码</td>
