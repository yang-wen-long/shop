...
<body>
	...
	<center>
			<h2>友情链接管理  </h2> <h3><a href="{{url('/area/index')}}">友情链接展示</a></h3>
		<form action="{{url('/area/store')}}" method="post" enctype="multipart/form-data">
			...
			<table border="1">
				<tr>
					<td>网站名称</td>
					<td>
						<input type="text" name="area_name" placeholder="网站名称">
				...
				<tr>
					<td>网站网址</td>
					<td>
						<input type="text" name="area_website" placeholder="网站网址">
				...
				<tr>
					<td>网站类型</td>
					<td>
						<input type="radio" name="area_data" value="1" checked>LOGO阅读
						<input type="radio" name="area_data" value="2">文件分享
				...
				<tr>
					<td>网站联系人</td>
					<td>
						<input type="text" name="area_linkman" placeholder="网站联系人">
				...
				<tr>
					<td>网站介绍</td>
					<td>
						<textarea name="area_text" placeholder="网站介绍" cols="30" rows="10"></textarea>
				...
				<tr>
					<td>是否显示</td>
					<td>
						<input type="radio" name="is_desc" value="1" checked>是
						<input type="radio" name="is_desc" value="2">否
